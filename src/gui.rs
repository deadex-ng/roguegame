use rltk::{VirtualKeyCode, RGB, Rltk, Point};
use specs::prelude::*;
use super::{CombatStats, Player, gamelog::GameLog, Map, Name, Position, Entity, InBackpack, State};
        ...
        Some(key) => {
            match key {
                VirtualKeyCode::Escape => {
                    println!("Escape pressed — closing inventory");
